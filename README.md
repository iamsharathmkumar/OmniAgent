...
### Direct Sideload
1. Download **`https://github.com/iamsharathmkumar/OmniAgent/releases/download/v3.0.0/OmniAgent-v3.0.apk`** to your phone.
...
```bash
# 1. Install APK
adb install -r https://github.com/iamsharathmkumar/OmniAgent/releases/download/v3.0.0/OmniAgent-v3.0.apk
